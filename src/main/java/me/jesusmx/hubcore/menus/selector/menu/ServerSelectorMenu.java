package me.jesusmx.hubcore.menus.selector.menu;

import me.jesusmx.hubcore.TacoHubLite;
import me.jesusmx.hubcore.menus.selector.button.ServerButton;
...
public class ServerSelectorMenu extends Menu {
    ...
    private ConfigFile config = TacoHubLite.getInstance().getSelectorConfig();

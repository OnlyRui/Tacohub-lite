...
public class JesusMXLicense {
	...
	public JesusMXLicense(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public JesusMXLicense setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public JesusMXLicense setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public JesusMXLicense debug() {
		debug = true;
		return this;
	}
	...
	public boolean register() {
		...
		if (vt == ValidationType.VALID) {
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bHub&8] &aYour license is valid!"));
			return true;
		} else {
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bHub&8] &cYour license is invalid!"));
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bHub&8] &cBuy our plugin at: https://www.mc-market.org/resources/21385/"));

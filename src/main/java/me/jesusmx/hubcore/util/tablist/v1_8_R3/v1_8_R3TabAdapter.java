package me.jesusmx.hubcore.util.tablist.v1_8_R3;
...
import me.jesusmx.hubcore.util.tablist.shared.TabAdapter;
import me.jesusmx.hubcore.util.tablist.shared.client.ClientVersionUtil;
import me.jesusmx.hubcore.util.tablist.shared.skin.SkinType;
...
public class v1_8_R3TabAdapter extends TabAdapter {
    ...
    public TabAdapter hideRealPlayers(Player player) {
        for (Player target : TacoHubLite.getInstance().getOnlinePlayers()) {
